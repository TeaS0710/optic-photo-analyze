...
def resolve_image_path(raw_path: str, output_dir: Path) -> Path:
    ...
    candidates = [
        ...
        (output_dir.parent.parent / path).resolve(),
    ]
...
<head>
  ...
  <title>Photo Corpus Study</title>
...
<body>
  ...
  <footer class="footer">
    <div class="shell">
      Generated automatically from the root project pipeline and corpus study outputs.
    </div>
  </footer>
</body>
</html>
...
def main() -> int:
    ...
    for index, record in enumerate(records, start=1):
        image_path = resolve_image_path(record["image_path"], args.output_dir)
